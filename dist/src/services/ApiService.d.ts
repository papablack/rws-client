...
declare class ApiServiceInstance extends TheService {
    private token?;
    constructor();
    private addHeader;
    private getHeaders;
    setToken(token: string): void;
    pureGet(url: string, options?: IAPIOptions): Promise<string>;
    isGetTargetReachable(url: string, options?: IAPIOptions): Promise<boolean>;
    ...
    connectToAmplify(): void;
}
declare const apiService: ApiServiceInstance;
