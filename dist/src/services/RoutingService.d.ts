...
declare const renderRouteComponent: (routeName: string, cmp: typeof RWSViewComponent, defaultRouteParams?: any) => () => [string, typeof RWSViewComponent, any];
...
declare const RWSRoutingService: RoutingService;
